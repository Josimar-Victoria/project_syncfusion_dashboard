...
const Login = () => {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    const infoLocalUser = JSON.parse(
      localStorage.getItem("login-signup-project")
    );
  
    if (infoLocalUser && infoLocalUser.email && infoLocalUser.password) {
      if (
        infoLocalUser.email === detail.email &&
        infoLocalUser.password === detail.password
      ) {
        navigate("/");
      } else {
          ...
          <div className="mt-8">
            <div className="flex flex-col">
              ...
              <input
                ...
                value={detail.email}
                onChange={(e) =>
                  setDatail({ ...detail, email: e.target.value })
                }
            ...
            <div className="flex flex-col mt-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setDatail({ ...detail, password: e.target.value })
                }
                className="w-full border-2 border-gray-100 rounded-xl p-4 mt-1 bg-transparent"
                placeholder="Enter your email"
                type={"password"}
